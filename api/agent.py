...
async def useChat(prompt: str, namespace: str):
    ...
    vectors = [
        Embedding(values=prompt_vector, metadata={"text": prompt}),
        Embedding(values=message_vector, metadata={"text": message}),
    ]
